  ...
  return (
    <section className="px-4 pt-10 lg:px-20 lg:pt-28 flex gap-10 flex-col md:flex-row md:items-start lg:gap-16">
      ...
      <div className="md:basis-4/6 w-full">
        <p className="text-3xl md:text-3xl xl:text-4xl leading-[40px] md:leading-[50px] xl:leading-[55px]">
        ...
        <p className="mt-10 text-3xl md:text-3xl xl:text-4xl leading-[40px] md:leading-[50px] xl:leading-[55px]">
